...
@Controller
@CrossOrigin("http://localhost:4200") // front
...
public class FileController {
  ...
  public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file, @PathVariable("idAnnonce") Long idAnnonce) {
    String message = "";
    try {
      storageService.store(file,idAnnonce);
