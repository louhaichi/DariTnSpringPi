...
public class RDVController {
	...
	// create RDV 
	@PostMapping("/RDVs/{idAnnonce}/{idUser}")
	public RDV createRDV(RDV r, @PathVariable("idAnnonce") Long idAnnonce,@PathVariable("idUser") Long idUser) {
		
			return RDVservice.saveRDV(r, idAnnonce, idUser);
	}
